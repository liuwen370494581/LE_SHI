 ...
 */
public class LoadingFlashViews extends FrameLayout {
    ...
    public LoadingFlashViews(Context context) {
        this(context, null);
    }

    public LoadingFlashViews(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingFlashViews(Context context, AttributeSet attrs, int defStyleAttr) {
